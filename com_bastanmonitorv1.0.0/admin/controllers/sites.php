...
class BastanmonitorControllerSites extends AdminController {
    ...
    /**
     * دکمه همگام‌سازی دستی از مدیریت سایت‌ها
     */
    ...
    /**
     * اجرای خودکار از طریق کرون‌جاب هاست (Cron Job)
     */
    public function cron() {
        ...
        // پیام‌های کرون معمولاً در لاگ سرور می‌مانند و انگلیسی بودنشان استانداردتر است
        echo "Cron Job executed successfully. Total: " . count($sites) . " sites ($successCount success, $errorCount errors).";
        jexit();
    }

    /**
     * قلب تپنده و متد مشترک پردازش و تحلیل یک سایت
     */
