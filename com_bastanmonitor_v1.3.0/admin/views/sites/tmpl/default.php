        ...
        <table class="table table-striped table-hover align-middle">
            <thead>
                <tr>
                    ...
                    <th width="29%"><?php echo HTMLHelper::_('grid.sort', 'COM_BASTANMONITOR_FIELD_SITE_TITLE', 'a.title', $listDirn, $listOrder); ?></th>
                    <th width="60%" class="text-center"><?php echo HTMLHelper::_('grid.sort', 'COM_BASTANMONITOR_FIELD_HEALTH_SCORE', 'a.health_score', $listDirn, $listOrder); ?></th>
